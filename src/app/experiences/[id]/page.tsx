...
export default function Details() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4">
      ...
      <button
        onClick={() => router.back()}
        className="p-2 sm:p-3 flex items-center gap-2 text-black hover:text-black transition cursor-pointer"
      >
        <FaArrowLeft size={18} />
        <span className="text-sm font-medium">Details</span>
      </button>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mt-3 sm:mt-5">
        {/* LEFT SECTION */}
        <div className="lg:col-span-2">
          <Image
            ...
            width={765}
            height={381}
            className="w-full rounded-xl h-[220px] sm:h-[300px] md:h-[381px] object-cover"
          />

          <h2 className="text-[20px] sm:text-[24px] font-medium mt-4 sm:mt-5">
            {experience.title}
          </h2>
          ...
          <div className="mt-6 sm:mt-8">
            <h4 className="text-[16px] sm:text-[18px] font-medium mb-3">
              Choose date
            </h4>
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {dates.map((d) => (
                <button
                  ...
                  className={`cursor-pointer px-4 py-2 rounded-md border text-[14px] sm:text-[15px] font-medium transition-all ${
                    d === date
          ...
          <div className="mt-6 sm:mt-8">
              ...
              {selectedSlots?.map((slot) => {
                ...
                return (
                  <button
                    ...
                    className={`cursor-pointer flex items-center gap-1 px-4 py-2 rounded-md border text-[14px] sm:text-[15px] font-medium transition-all ${
                      isSoldOut
                  ...
                  >
                    ...
                    {!isSoldOut && (
                      <span className="text-[12px] text-[#FF3B30] ml-1">
                        {left} left
                      </span>
                    )}
                    {isSoldOut && (
                      <span className="text-[12px] text-[#6C6C6C] ml-1">
                        Sold out
                      </span>
                    )}
                  </button>
            ...
            <p className="text-[12px] sm:text-[13px] text-[#838383] mt-2">
          ...
          <div className="mt-6">
            ...
            <p className="text-[12px] sm:text-[13px] font-regular bg-[#EEEEEE] rounded p-3 text-[#838383] leading-relaxed">
        ...
        {/* RIGHT SIDEBAR */}
        <aside className="bg-[#EFEFEF] p-5 sm:p-6 rounded-xl shadow-sm h-fit">
          <div className="space-y-3 text-[15px] sm:text-[16px] text-[#656565]">
            ...
            <div className="flex justify-between font-medium text-[18px] sm:text-[20px] text-[#161616]">
              <span>Total</span>
              <span>₹{total}</span>
            </div>
            ...
            <button
              ...
              disabled={!time}
              className={`w-full mt-3 py-2 sm:py-2.5 rounded-lg font-medium transition ${
                time
